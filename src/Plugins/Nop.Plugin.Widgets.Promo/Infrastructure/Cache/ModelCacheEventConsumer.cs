...
namespace Nop.Plugin.Widgets.Promo.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.promo.text-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.promo";
